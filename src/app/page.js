    ...
    <div className="text-center p-8 lg:p-36 pt-0">
      <div className="flex flex-col lg:flex-row items-center justify-center mt-8">
        ...
        <section className="w-full lg:w-1/2 text-left flex flex-col justify-start items-start mt-8 lg:mt-0 lg:ml-8">
          <h1 className="text-lg md:text-4xl font-bold text-light-cyan font-playwrite">
            🤖 Welcome to Robosmart! 🚀
          </h1>
          <p className="text-light-cyan mt-4 text-md lg:text-2xl">
            ✨ We&apos;re Team #19110 from Colegiul Național &quot;Ion
            Minulescu&quot; Slatina, Olt, rocking the FIRST Tech Challenge scene!
          </p>
          <p className="mt-4 text-light-cyan text-md lg:text-2xl">
            💡 A squad of passionate innovators solving complex problems through
            robotics magic! Together we learn, build, and grow while creating awesome
            tech wonders!
          </p>
        </section>
      </div>
      ...
      {/* Sponsors Section */}
      <section className="mt-16 p-8 bg-gray-800/30 rounded-3xl backdrop-blur-lg shadow-lg mb-20">
        <h2 className="text-2xl md:text-4xl font-bold text-light-cyan border-b-2 border-light-cyan pb-2">
          Our Esteemed Sponsors
        </h2>
        <p className="mt-4 text-light-cyan text-md lg:text-2xl">
          Special thanks go to:
        </p>
        <ul className="mt-4 text-light-cyan list-disc list-inside space-y-2 text-md lg:text-2xl">
        <li>Team RoSophia #21455</li>
              <li>S.C. Provision Retail Prod S.R.L.</li>
              <li>Basarabikom S.R.L.</li>
              <li>S.C. ROMARKET S.R.L.</li>
              <li>BAV GRUP SOLUTION S.R.L.</li>
              <li>Condor Paduraru S.R.L.</li>
        </ul>
      </section>
    </div>
  );
